...
- **Authentication**: Secure signup and login using bcrypt password hashing and JWT (JSON Web Tokens).
...
- **Backend**: Node.js, Express 5, MongoDB (native driver), jsonwebtoken, bcryptjs, cors, dotenv
